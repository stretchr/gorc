...
// Represents a method call and is used for setting expectations,
...
// The workhorse used to track activity on another object. 
...
// Starts a description of an expectation of the specified method
// being called.
//
...
// Finishes a description of an expectation of the method (and arguments)
...
// Tells the mock object that a method has been called, and gets an array
...
// Asserts that everything specified with On and Return was
...
// Holds an array of method arguments or return values.
...
// A string that contains the type of an argument
// for use when type checking.  Used in Diff and Assert.
type AnythingOfTypeArgument string

// Returns an AnythingOfTypeArgument object containing the
...
// Gets a string describing the differences between the arguments
...
// Compares the arguments with the specified objects and fails if
...
// Gets the argument at the specified index. Panics if there is no argument, or
