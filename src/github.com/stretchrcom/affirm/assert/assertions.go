...
// Returns a string containing the file and line number of the assert call
// that failed. 
...
// Asserts that the specified object is of the specified type.
...
// Asserts that the specified string contains the specified substring.
...
// Defines a type that is used for type checking and convenience
type PanicTestFunc func()

// Returns true if the function passed to it panics. Otherwise, it returns false.
...
// Asserts that the function passed to it panics
...
// Asserts that the function passed to it does not panic
